...
**P1** · piste IA — des photos aux cartes · couloir **CH3** — Catalogue, prix & e2e (**chimera**) · prévu du 20 sept. au 20 sept. · jalon **MVP en UAT** · taille M · complexité 4/5 · difficulté 4/5
...
git commit -m "v3-identification-visuelle: …" && git push -u origin roadmap/v3-identification-visuelle
bash scripts/ouvrir-pr.sh roadmap/v3-identification-visuelle   # ouvre la PR, ou echoue en disant pourquoi
```
