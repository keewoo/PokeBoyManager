...
**P0** · piste Fondations & livraison · couloir **DA2** — Livraison & infra (seul à déployer) (**devAI**) · prévu du 19 sept. au 19 sept. · jalon **MVP en UAT** · taille S · complexité 2/5 · difficulté 2/5
...
git commit -m "v0-flotte: …" && git push -u origin roadmap/v0-flotte
bash scripts/ouvrir-pr.sh roadmap/v0-flotte   # ouvre la PR, ou echoue en disant pourquoi
```
