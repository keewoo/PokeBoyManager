...
- `release_uat` — Recette locale sur chimera (sans objet : joué avec v1-uat)
...
git commit -m "v0-schema: …" && git push -u origin roadmap/v0-schema
bash scripts/ouvrir-pr.sh roadmap/v0-schema   # ouvre la PR, ou echoue en disant pourquoi
```
