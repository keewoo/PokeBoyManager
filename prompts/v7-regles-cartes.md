...
git commit -m "v7-regles-cartes: …" && git push -u origin roadmap/v7-regles-cartes
bash scripts/ouvrir-pr.sh roadmap/v7-regles-cartes   # ouvre la PR, ou echoue en disant pourquoi
```
