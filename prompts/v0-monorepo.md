...
**P0** · piste Fondations & livraison · couloir **DA1** — API, comptes & données (**devAI**) · prévu du 19 sept. au 19 sept. · jalon **MVP en UAT** · taille M · complexité 3/5 · difficulté 2/5
...
- `release_uat` — Recette locale sur chimera (sans objet : socle technique)
...
git commit -m "v0-monorepo: …" && git push -u origin roadmap/v0-monorepo
bash scripts/ouvrir-pr.sh roadmap/v0-monorepo   # ouvre la PR, ou echoue en disant pourquoi
```
