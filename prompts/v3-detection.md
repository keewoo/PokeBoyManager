...
git commit -m "v3-detection: …" && git push -u origin roadmap/v3-detection
bash scripts/ouvrir-pr.sh roadmap/v3-detection   # ouvre la PR, ou echoue en disant pourquoi
```
