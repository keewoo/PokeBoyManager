...
**P1** · piste Collection & fiche carte · couloir **DA1** — API, comptes & données (**devAI**) · prévu du 19 sept. au 19 sept. · jalon **MVP en UAT** · taille S · complexité 2/5 · difficulté 2/5
...
git commit -m "v4-ranking: …" && git push -u origin roadmap/v4-ranking
bash scripts/ouvrir-pr.sh roadmap/v4-ranking   # ouvre la PR, ou echoue en disant pourquoi
```
