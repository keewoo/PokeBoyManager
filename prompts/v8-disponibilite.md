...
git commit -m "v8-disponibilite: …" && git push -u origin roadmap/v8-disponibilite
bash scripts/ouvrir-pr.sh roadmap/v8-disponibilite   # ouvre la PR, ou echoue en disant pourquoi
```
