...
git commit -m "v3-identification: …" && git push -u origin roadmap/v3-identification
bash scripts/ouvrir-pr.sh roadmap/v3-identification   # ouvre la PR, ou echoue en disant pourquoi
```
