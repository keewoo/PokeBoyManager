...
**P0** · piste Jeu — decks et parties · couloir **DA1** — API, comptes & données (**devAI**) · prévu du 15 févr. au 19 févr. · jalon **En ligne** · taille M · complexité 4/5 · difficulté 4/5
...
git commit -m "v7-temps-reel: …" && git push -u origin roadmap/v7-temps-reel
bash scripts/ouvrir-pr.sh roadmap/v7-temps-reel   # ouvre la PR, ou echoue en disant pourquoi
```
