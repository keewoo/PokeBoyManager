...
git commit -m "v7-regles-moteur: …" && git push -u origin roadmap/v7-regles-moteur
bash scripts/ouvrir-pr.sh roadmap/v7-regles-moteur   # ouvre la PR, ou echoue en disant pourquoi
```
