...
git commit -m "v2-catalogue: …" && git push -u origin roadmap/v2-catalogue
bash scripts/ouvrir-pr.sh roadmap/v2-catalogue   # ouvre la PR, ou echoue en disant pourquoi
```
