...
git commit -m "v4-insights-batch: …" && git push -u origin roadmap/v4-insights-batch
bash scripts/ouvrir-pr.sh roadmap/v4-insights-batch   # ouvre la PR, ou echoue en disant pourquoi
```
