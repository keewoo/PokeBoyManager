...
**P0** · piste Compte privé & sécurité · couloir **CH1** — Front — comptes, accueil & collection (**chimera**) · prévu du 19 sept. au 19 sept. · jalon **MVP en UAT** · taille S · complexité 2/5 · difficulté 2/5
...
- `release_uat` — Recette locale sur chimera (sans objet : déployé avec la mise en PROD)
...
git commit -m "v1-identite: …" && git push -u origin roadmap/v1-identite
bash scripts/ouvrir-pr.sh roadmap/v1-identite   # ouvre la PR, ou echoue en disant pourquoi
```
