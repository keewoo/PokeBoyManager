...
git commit -m "v7-decks-collection-sync: …" && git push -u origin roadmap/v7-decks-collection-sync
bash scripts/ouvrir-pr.sh roadmap/v7-decks-collection-sync   # ouvre la PR, ou echoue en disant pourquoi
```
