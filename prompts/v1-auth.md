...
**P0** · piste Compte privé & sécurité · couloir **DA1** — API, comptes & données (**devAI**) · prévu du 19 sept. au 19 sept. · jalon **MVP en UAT** · taille M · complexité 4/5 · difficulté 3/5
...
git commit -m "v1-auth: …" && git push -u origin roadmap/v1-auth
bash scripts/ouvrir-pr.sh roadmap/v1-auth   # ouvre la PR, ou echoue en disant pourquoi
```
