...
**P0** · piste IA — des photos aux cartes · couloir **CH2** — IA & vision (**chimera**) · prévu du 19 sept. au 19 sept. · jalon **MVP en UAT** · taille M · complexité 3/5 · difficulté 3/5
...
git commit -m "v3-ia-providers: …" && git push -u origin roadmap/v3-ia-providers
bash scripts/ouvrir-pr.sh roadmap/v3-ia-providers   # ouvre la PR, ou echoue en disant pourquoi
```
