...
**P0** · piste Catalogue & prix · couloir **CH3** — Catalogue, prix & e2e (**chimera**) · prévu du 19 sept. au 20 sept. · jalon **MVP en UAT** · taille M · complexité 3/5 · difficulté 3/5
...
- `release_uat` — Recette locale sur chimera (sans objet : appliqué par le déploiement)
...
git commit -m "v2-catalogue-complet: …" && git push -u origin roadmap/v2-catalogue-complet
bash scripts/ouvrir-pr.sh roadmap/v2-catalogue-complet   # ouvre la PR, ou echoue en disant pourquoi
```
