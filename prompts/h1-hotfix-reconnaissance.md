...
git commit -m "h1-hotfix-reconnaissance: …" && git push -u origin roadmap/h1-hotfix-reconnaissance
bash scripts/ouvrir-pr.sh roadmap/h1-hotfix-reconnaissance   # ouvre la PR, ou echoue en disant pourquoi
```
