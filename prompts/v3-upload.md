...
**P0** · piste IA — des photos aux cartes · couloir **CH4** — Front — photos, validation & fiche carte (**chimera**) · prévu du 19 sept. au 19 sept. · jalon **MVP en UAT** · taille M · complexité 3/5 · difficulté 2/5
...
git commit -m "v3-upload: …" && git push -u origin roadmap/v3-upload
bash scripts/ouvrir-pr.sh roadmap/v3-upload   # ouvre la PR, ou echoue en disant pourquoi
```
