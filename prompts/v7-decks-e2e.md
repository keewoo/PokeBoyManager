...
git commit -m "v7-decks-e2e: …" && git push -u origin roadmap/v7-decks-e2e
bash scripts/ouvrir-pr.sh roadmap/v7-decks-e2e   # ouvre la PR, ou echoue en disant pourquoi
```
